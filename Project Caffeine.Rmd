...
#There is insufficient evidence to reject the H0 that the subject's caffeine consumption is greater than the FDA recommended of 400.
```
```{r}
...
model4<- lm(`amount total`~liquid+food+liquid*food, data=Data_211_project )
summary(model4)
